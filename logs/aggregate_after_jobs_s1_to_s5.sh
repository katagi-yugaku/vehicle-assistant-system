...
echo "[INFO] expected branch: auto/aggregate-s1-to-s5-20260511-183806"
...
if [[ "1" == "1" ]]; then
  ...
  if [[ "${current_branch}" != "auto/aggregate-s1-to-s5-20260511-183806" ]]; then
    echo "ERROR: aggregate job 実行時の branch が想定と異なります"
    echo "expected: auto/aggregate-s1-to-s5-20260511-183806"
...
if [[ "1" == "1" ]]; then
  ...
  echo "[INFO] push branch: origin/auto/aggregate-s1-to-s5-20260511-183806"
  git push -u "origin" "auto/aggregate-s1-to-s5-20260511-183806"
else
