...
echo "[INFO] expected branch: auto/aggregate-s1-to-s5-20260512-013310"
...
if [[ "1" == "1" ]]; then
  ...
  if [[ "${current_branch}" != "auto/aggregate-s1-to-s5-20260512-013310" ]]; then
    echo "ERROR: aggregate job 実行時の branch が想定と異なります"
    echo "expected: auto/aggregate-s1-to-s5-20260512-013310"
...
if [[ "1" == "1" ]]; then
  ...
  echo "[INFO] push branch: origin/auto/aggregate-s1-to-s5-20260512-013310"
  git push -u "origin" "auto/aggregate-s1-to-s5-20260512-013310"
else
