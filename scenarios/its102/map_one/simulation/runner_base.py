...
if __name__ == "__main__":
    ...
    DRIVER_VISIBILITY_DISTANCE: float = float(sys.argv[4])

    print(f"early_rate: {early_rate}, vehicle_interval: {vehicle_interval}, DRIVER_VISIBILITY_DISTANCE: {DRIVER_VISIBILITY_DISTANCE}")
    options = get_options()
    if options.nogui:
