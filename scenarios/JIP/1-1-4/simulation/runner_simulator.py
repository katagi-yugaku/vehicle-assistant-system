                        ...
                        if congestion_flg:
                            if current_edgeID in ["E1", "E20"]:
                                ...
                                if routeID is not None:
                                    ...
                                    traci.vehicle.setColor(current_vehID, ROUTE_CHANGE_COLOR)
                                    _mark_route_changed(
                                        vehID=current_vehID,
                                        agent=agent_by_current_vehID,
                        ...
                        # ============================================================
                            ...
                            if rc_around_count > 0 and random.random() < P_FOLLOW:
                                if current_edgeID in ["E1", "E20"]:
                                    ...
                                    if current_edgeID == from_edgeID and route_edges_for_sumo:
                                        route_changed = _apply_route_edges_for_sumo(
                                            vehID=current_vehID,
                                            current_edgeID=current_edgeID,
                                            route_edges_for_sumo=route_edges_for_sumo,
...
#                                     if current_edgeID == from_edgeID:
#                                         # 経路を変更する
#                                         traci.vehicle.setRoute(current_vehID, to_edge_list[0])
#                                         traci.vehicle.setRouteID(current_vehID, routeID)
#                                         traci.vehicle.setColor(current_vehID,(60, 180, 120))
#                                         continue
#                                     from_edgeID, shelterID, to_edge_list = (
