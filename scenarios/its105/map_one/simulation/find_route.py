...
if __name__ == "__main__":
    # python3 -m scenarios.its105.map_one.simulation.find_route --nogui
    options = get_options()
    ...
    shelter_capacity_by_ID:dict = {"ShelterA": 100}
    shelter_edge_by_IDs:dict = {"ShelterA": 'E16'}   
    ...
    traci.start([sumoBinary, "-c", "/Users/kashiisamutakeshi/vehicle-assistant-system/scenarios/its105/map_one/data/ishinomaki_toymap.sumocfg",
    ...
    utilities.export_connected_edges_to_json(connected_edges_list=connected_edges_list,
                                                file_path="/Users/kashiisamutakeshi/vehicle-assistant-system/scenarios/its105/map_one/data/all_edgeIDs.json")
    ...
    utilities.export_start_end_edgeIDs_to_json(start_end_edgeIDs=nearest_end_edgeID_by_start_edgeID_dict,
                                                file_path="/Users/kashiisamutakeshi/vehicle-assistant-system/scenarios/its105/map_one/data/start_end_edgeIDs_ishinomaki_toymap.json")
