...
if __name__ == "__main__":
    ...
    options = get_options()
    file_path = "data/ishinomaki_toymap.rou.xml"
    if options.nogui:
    ...
    traci.start([sumoBinary, "-c", "/Users/kashiisamutakeshi/vehicle-assistant-system/scenarios/JIP/1-1-2/data/ishinomaki_one_two_one.sumocfg",
    ...
    utilities.export_connected_edges_to_json(connected_edges_list=connected_edges_list,
                                                file_path="/Users/kashiisamutakeshi/vehicle-assistant-system/scenarios/JIP/1-1-2/data/all_edgeIDs.json")
    ...
    utilities.export_start_end_edgeIDs_to_json(start_end_edgeIDs=nearest_end_edgeID_by_start_edgeID_dict,
                                                file_path="/Users/kashiisamutakeshi/vehicle-assistant-system/scenarios/JIP/1-1-2/data/start_end_edgeIDs_ishinomaki_two_shelter.json")
